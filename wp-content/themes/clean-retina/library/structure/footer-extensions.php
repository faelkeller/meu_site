...
function cleanretina_footer_info() {         
   $output = '<div class="copyright">'.__( 'Copyright &copy;', 'clean-retina' ).' '.cleanretina_the_year().' ' .cleanretina_site_link().' | ' . ' '.__( 'Theme by:', 'clean-retina' ).' '.cleanretina_themehorse_link().' | '.' '.__( 'Powered by:', 'clean-retina' ).' '.cleanretina_wp_link() .'</div><!-- .copyright -->';
   echo $output;
}
